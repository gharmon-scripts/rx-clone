...
ssh $1 '. /etc/profile; acli image.create Windows2K16_GUI container=Images image_type=kDiskImage source_url=http://10.63.25.20/Repo/Mounts/Training/SRE-Training/win_2k16_gui.qcow2'
ssh $1 '. /etc/profile; acli image.create Windows2K16_CORE container=Images image_type=kDiskImage source_url=http://10.63.25.20/Repo/Mounts/Training/SRE-Training/win_2k16_core.qcow2'
